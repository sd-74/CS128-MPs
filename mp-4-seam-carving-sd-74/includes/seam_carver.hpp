...
public:
  ...
  void InitializeArrHorizontal(int** arr) const;
  void InitializeArrVertical(int** arr) const;
  int* FindMinHorizontalPath(int** arr) const;
  int* FindMinVerticalPath(int** arr) const;
